...
public class BusquedaScursal extends javax.swing.JFrame{
	...
	private void initialize() {
		...
		JLabel titulo = new JLabel("Buscar Sucursal");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(DTO!=null){
					AltaSucursal inst2 = new AltaSucursal(DTO);
