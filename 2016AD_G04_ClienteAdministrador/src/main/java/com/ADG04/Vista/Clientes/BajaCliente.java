...
public class BajaCliente extends javax.swing.JFrame{
	...
	private void initialize() {
		...
		JLabel titulo = new JLabel("Baja Cliente");
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (clienteDTO != null){
					cliente.setText(clienteDTO.getEmail());
					...
					JOptionPane.showMessageDialog(null,"No se ha encontrado el cliente.Puede tener Encomiendas pendientes asociadas", "Error", JOptionPane.ERROR_MESSAGE);
					id.setText("");
				}
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
					...
					boolean flag = Controlador.getInstancia().bajaCliente(clienteDTO.getId());

					if(flag){
						JOptionPane.showMessageDialog(null,"Se ha dado de baja el cliente", "Baja cliente realizado", JOptionPane.INFORMATION_MESSAGE);
						setVisible(false);
					} else {
