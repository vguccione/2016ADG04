...
public class BajaPlanMantenimiento extends javax.swing.JFrame {
	...
	private void initialize() {
		...
		JLabel titulo = new JLabel("Baja Plan Matenimiento");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
					...
					boolean flag = Controlador.getInstancia().bajaPlanMantenimiento(clienteDTO.getId());

					if(flag){
						JOptionPane.showMessageDialog(null,"Se ha dado de baja el plan", "Baja plan realizado", JOptionPane.INFORMATION_MESSAGE);
						System.exit(0);
					} else {
						JOptionPane.showMessageDialog(null,"No se ha podido dar de baja al plan.", "Error", JOptionPane.ERROR_MESSAGE);	
					}
			}
		});
