...
public class RegistrarTareaRealizada {
	...
	private DTO_Vehiculo clienteDTO;
	...
	private void initialize() {
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				clienteDTO = Controlador.getInstancia().buscarVehiculo(patente.getText());
				if (clienteDTO != null){
					cliente.setText(clienteDTO.getTipo() + " " + clienteDTO.getMarca());

					planDTO = Controlador.getInstancia().getPlanMantenimiento(clienteDTO.getId());
					if(planDTO != null){
		...
		btnBuscar.setBounds(160, 26, 65, 23);
		panel.add(btnBuscar);
		...
		lblProveedor_1.setBounds(6, 84, 78, 15);
		...
		button_2.setBounds(161, 81, 65, 23);
		...
		lblProveedor.setBounds(229, 85, 215, 14);
		...
		button.setBounds(399, 258, 75, 23);
		button.setVisible(false);
		frame.getContentPane().add(button);
		
		button_1 = new JButton();
		button_1.setText("Aceptar");
		button_1.setBounds(318, 258, 71, 23);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				boolean flag = Controlador.getInstancia().altaTareaMantenimientoRealizada(t.getId(), clienteDTO.getId(), new Date(), clienteDTO.getKmsRecorridos(), proveedorDTO.getId());
