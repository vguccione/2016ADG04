...
public class BajaServicioSeguridad extends javax.swing.JFrame{
	...
	private void initialize() {
		...
		JLabel titulo = new JLabel("Baja Servicio Seguridad");
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (DTO != null){
					...
					JOptionPane.showMessageDialog(null,"No se ha encontrado el Servicio de Seguridad.", "Error", JOptionPane.ERROR_MESSAGE);
					id.setText("");
				}
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
					...
					boolean flag = Controlador.getInstancia().bajaServicioSeguridad(DTO.getId());

					if(flag){
						JOptionPane.showMessageDialog(null,"Se ha dado de baja el Servicio de Seguridad", "Baja Servicio Seguridad realizado", JOptionPane.INFORMATION_MESSAGE);
						setVisible(false);
					} else { 
						JOptionPane.showMessageDialog(null,"No se ha podido dar de baja al Servicio de Seguridad.", "Error", JOptionPane.ERROR_MESSAGE);	
					}
			}
		});
