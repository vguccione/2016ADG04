...
public class BajaVehiculo extends javax.swing.JFrame{
	...
	private void initialize() {
		...
		JLabel titulo = new JLabel("Baja Vehiculo");
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				DTO = Controlador.getInstancia().getVehiculoById((Integer)id.getValue());
				if (DTO != null){
					cliente.setText(DTO.getPatente());
					...
					JOptionPane.showMessageDialog(null,"No se ha encontrado el vehiculo. Puede tener envios asociados", "Error", JOptionPane.ERROR_MESSAGE);
					id.setText("");
				}
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
					...
					boolean flag = Controlador.getInstancia().bajaVehiculo(DTO.getId());

					if(flag){
						JOptionPane.showMessageDialog(null,"Se ha dado de baja el Vehiculo", "Baja vehiculo realizado", JOptionPane.INFORMATION_MESSAGE);
						setVisible(false);
					} else {
						JOptionPane.showMessageDialog(null,"No se ha podido dar de baja al vehiculo.", "Error", JOptionPane.ERROR_MESSAGE);	
					}
			}
		});
