...
public class TareaMantenimientoPorKmE extends TareaMantenimientoE implements java.io.Serializable {

	@Column(name = "CantidadKilometros", precision = 53, scale = 0)
	private float cantidadKilometros;

	public TareaMantenimientoPorKmE() {
		super();
	}

	public TareaMantenimientoPorKmE(PlanMantenimientoE planMantenimiento, String tarea) {
