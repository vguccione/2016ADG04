...
*/
public class ListadoPlanMantenimiento extends javax.swing.JFrame {
	/**
	 * 
	 */
	...
	public ListadoPlanMantenimiento() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			getContentPane().setLayout(null);
			{
				...
				jLabelTitulo.setText("Listado Plan de Mantenimiento");
			...
			}
			{
				...
				jScrollPaneListadoVehiculos.setBounds(12, 60, 799, 305);
				{
					...
					List<DTO_PlanMantenimiento> listaDTO = Controlador.getInstancia().listarPlanMantenimiento();
					
					DefaultTableModel jTableListadoModel = new DefaultTableModel();
			
					jTableListadoModel.addColumn("Descripcion");
					jTableListadoModel.addColumn("Cometarios");

					
					for (DTO_PlanMantenimiento item :listaDTO){
						
						
						jTableListadoModel.addRow(new Object[] { item.getDescripcion(),
																item.getComentarios()
						});
